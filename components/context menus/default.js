  ...
  return (
    ...
    >
      <a
        ...
        href="https://github.com/bayramdev/portfolio"
        target="_blank"
      ...
      <a
        rel="noreferrer noopener"
        href="https://github.com/bayramdev/portfolio/issues"
        target="_blank"
        className="w-full block cursor-default py-0.5 hover:bg-ub-warm-grey hover:bg-opacity-20 mb-1.5"
      >
        <span className="ml-5">❗</span>{" "}
      ...
      <a
        rel="noreferrer noopener"
        href="https://www.linkedin.com/in/bayram-kaz%C4%B1k-ab2b5b193/"
        target="_blank"
        className="w-full block cursor-default py-0.5 hover:bg-ub-warm-grey hover:bg-opacity-20 mb-1.5"
      >
      ...
      <a
        rel="noreferrer noopener"
        href="https://github.com/bayramdev"
        target="_blank"
        className="w-full block cursor-default py-0.5 hover:bg-ub-warm-grey hover:bg-opacity-20 mb-1.5"
      >
        <span className="ml-5">🤝</span>{" "}
      ...
      <a
        rel="noreferrer noopener"
        href="mailto:d609d8j01@mozmail.com"
        target="_blank"
        className="w-full block cursor-default py-0.5 hover:bg-ub-warm-grey hover:bg-opacity-20 mb-1.5"
      >
        <span className="ml-5">📥</span>{" "}
